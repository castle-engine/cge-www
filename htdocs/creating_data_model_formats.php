...
<ul>
  ...
  <li><p>Collisions automatically work (as with all other scene formats), you only have to initialize <a href="https://castle-engine.io/apidoc-unstable/html/CastleSceneCore.TCastleSceneCore.html#Spatial">Scene.Spatial</a> (see the <a href="https://castle-engine.io/manual_load_3d.php">manual</a>). By default, static meshes have precise collisions (treating them like a set of triangles), while skinned-animated meshes collide as simple bounding boxes (so they don't cause a slowdown when animating). This can be even customized per-shape by adjusting <a href="https://castle-engine.io/apidoc-unstable/html/X3DNodes.TAbstractShapeNode.html#Collision">Shape.collision</a> property.
