...
<ul>
  ...
  <li><code>"scene"</code> is an URL or a filename of the 3D model containing the level. Usually it's a simple filename, but you could as well use here an <code>http:</code> URL to <?php echo a_href_page('download the actual 3D data from the Internet', 'tutorial_network'); ?>.
