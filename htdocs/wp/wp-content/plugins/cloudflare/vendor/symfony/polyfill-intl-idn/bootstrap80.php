...
if (!\function_exists('idn_to_ascii') && !\function_exists('Cloudflare\APO\Vendor\idn_to_ascii')) {
...
if (!\function_exists('idn_to_utf8') && !\function_exists('Cloudflare\APO\Vendor\idn_to_utf8')) {
