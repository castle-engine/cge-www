=== Twenty Seventeen for CGE ===

This is a *minimal* modification of the twentyseventeen Wordpress theme
from Wordpress 4.7.2, to change things that cannot be sensibly changed
in the child theme "cge".

Right now, this is only a single change:

- In style.css, replace dropdown-toggle with dropdown-toggle-twentyseventeen
  (to not conflict with Bootstrap's dropdown-toggle, that we use for
  "Documentation" menu).
