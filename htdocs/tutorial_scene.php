...
<ul>
  ...
  <li><p>The one thing you should <i>not</i> do during the game, if you hope to have a good performance: <i>do not load from 3D model files</i> during the game (e.g. do not call <?php api_link('TCastleSceneCore.Load(URL, ...)', 'CastleSceneCore.TCastleSceneCore.html#Load'); ?> method).</p>
    ...
    <p>See <?php echo a_href_page('the tutorial chapter about optimization for more hints', 'tutorial_optimization'); ?>.
  </li>
</ul>
...
begin
  ...
  Result.Load(RootNode, true);
    ...
    <p>This is explained in detail in the <?php echo a_href_page('chapter about the transformation hierarchy', 'tutorial_transformation_hierarchy'); ?>.</p>
  </li>
...
<p>In fact, this is how our <?php echo a_href_page('creatures with ready AI', 'tutorial_resources_using_existing'); ?>
