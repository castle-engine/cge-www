...
<a href="' . CURRENT_URL . 'engine.php" class="btn btn-primary btn-lg">Go to Castle Game Engine 5.1.1 sources and documentation!</a>
</div>
...
<ol>
  ...
  <li><a href="http://castle-engine.sourceforge.net/x3d_implementation_text.php">X3D Text node</a> gets a new implementation, very fast, portable to OpenGLES (Android/iOS), and easy to use (shares tools and classes with 2D text rendering). You can also control <a href="http://castle-engine.sourceforge.net/x3d_implementation_text_extensions.php#section_ext_fontstyle_blending">whether it uses alpha blending or alpha test</a>.
  ...
  <li>Many improvements for 2D games. Besides Spine support, there\'s also a comfortable <a href="http://castle-engine.sourceforge.net/apidoc/html/Castle2DSceneManager.T2DSceneManager.html">T2DSceneManager</a> and <a href="http://castle-engine.sourceforge.net/apidoc/html/Castle2DSceneManager.T2DScene.html">T2DScene</a>. See <code>castle_game_engine/examples/2d_spine_game/</code> for example of use.
  <li>Many improvements for Android. See <a href="http://castle-engine.sourceforge.net/tutorial_mobile.php">new tutorial page about developing mobile games</a>. Try our "portable games skeleton" code in <code>castle_game_engine/examples/portable_game_skeleton</code>.
...
<ol>
  ...
  <li><p><b>Comfortable API for 2D rendering</b></p>
    ...
    <ul>
      ...
      <li><p>All <a href="http://castle-engine.sourceforge.net/apidoc/html/CastleControls.html">CastleControls</a> components use now <code>TGLImage</code> for all of their rendering. They use <a href="http://castle-engine.sourceforge.net/apidoc/html/CastleControls.TCastleTheme.html">TCastleTheme</a> (as <code>Theme</code> global instance) to get their images, this way you can easily change the look of all controls defined in <a href="http://castle-engine.sourceforge.net/apidoc/html/CastleControls.html">CastleControls</a>.

      <li><p>Dialog boxes in <a href="http://castle-engine.sourceforge.net/apidoc/html/CastleMessages.html">CastleMessages</a> unit are also using <code>TGLImage</code> for the rendering. They also use normal buttons at the bottom, so they are clickable and generally look and behave like normal dialog windows with normal buttons :) Same thing for the progress bar.
