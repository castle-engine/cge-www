...
<ol>
  ...
  <li>Many improvements for Android. See <a href="https://castle-engine.io/manual_cross_platform.php">new tutorial page about developing mobile games</a>. Try our "portable games skeleton" code in <code>castle_game_engine/examples/portable_game_skeleton</code>.
...
<ol>
  <li>Yes, you have heard right: <b>the engine supports Android and iOS (iPhone, iPad)</b>.
    ...
    <p>The Android port uses <a href="http://developer.android.com/reference/android/app/NativeActivity.html">NativeActivity</a>, available since Android 2.3. It requires FPC 2.7.1 to cross-compile code to Android ARM, see <a href="http://wiki.freepascal.org/Android">FPC wiki about Android</a>. Integration with Android includes using Android\'s log facility (just use <a href="' . CURRENT_URL . 'log">WritelnLog from CastleLog</a> unit) and using Android\'s assets (URLs like <code>assets:/my_texture.png</code> are supported, and <a href="https://castle-engine.io/apidoc/html/CastleFilesUtils.html#ApplicationData">ApplicationData</a> returns <code>assets:/</code> to read data from apk).
