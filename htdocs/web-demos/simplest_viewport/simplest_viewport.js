...
rtl.module("wasienv",["System","SysUtils","Classes","JS","webassembly","Types","wasitypes"],function () {
  ...
  rtl.createClass(this,"TPas2JSWASIEnvironment",pas.System.TObject,function () {
    ...
    this.GetUTF8StringFromMem = function (aLoc, aLen) {
      ...
      var SrcBytes = null;
      var tmpBytes = null;
      if (rtl.isExt(this.getModuleMemoryDataView().buffer,SharedArrayBuffer)) {
...
rtl.module("program",["System","Classes","SysUtils","wasienv","Web","BrowserApp","JS","webassembly","wasihostapp","browserconsole","JOB_Browser"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass(this,"TMyApplication",pas.wasihostapp.TBrowserWASIHostApplication,function () {
    ...
    this.DoRun = function () {
      ...
      this.StartWebAssembly("simplest_viewport.wasm?random_suffix_to_avoid_cache=ZRKCB779",true,rtl.createCallback(this,"DoBeforeStart"),null);
      this.Terminate();
    };
    this.Create$1 = function (aOwner) {
