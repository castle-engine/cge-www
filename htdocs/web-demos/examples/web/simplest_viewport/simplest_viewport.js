...
rtl.module("wasienv",["System","SysUtils","Classes","JS","webassembly","Types","wasitypes"],function () {
  ...
  rtl.createClass(this,"TPas2JSWASIEnvironment",pas.System.TObject,function () {
    ...
    this.GetUTF8StringFromMem = function (aLoc, aLen) {
      ...
      var SrcBytes = null;
      var tmpBytes = null;
      if (pas.JS.isDefined(self["SharedArrayBuffer"]) && rtl.isExt(this.getModuleMemoryDataView().buffer,SharedArrayBuffer)) {
        src = this.getModuleMemoryDataView().buffer.slice(aLoc,aLoc + aLen);
        SrcBytes = new Uint8Array(src);
        tmpBuf = new ArrayBuffer(aLen);
        tmpBytes = new Uint8Array(tmpBuf);
        tmpBytes.set(SrcBytes);
        Result = this.UTF8TextDecoder.decode(tmpBuf);
      } else Result = this.UTF8TextDecoder.decode(this.getModuleMemoryDataView().buffer.slice(aLoc,aLoc + aLen));
      return Result;
    };
...
rtl.module("program",["System","Classes","SysUtils","Math","wasienv","Web","BrowserApp","JS","webassembly","wasihostapp","browserconsole","JOB_Browser"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass(this,"TMyApplication",pas.wasihostapp.TBrowserWASIHostApplication,function () {
    ...
    this.DataLoaded = function (Event) {
      ...
      function DoStartWebAssembly() {
        ...
        $Self.StartWebAssembly("simplest_viewport.wasm?random_suffix_to_avoid_cache=APLTET348",true,rtl.createCallback($Self,"DoBeforeStart"),null);
      };
      var Xhr = null;
    ...
    this.DoRun = function () {
      var Xhr = null;
      var DataUrl = "";
      DataUrl = "simplest_viewport_data.zip?random_suffix_to_avoid_cache=APLTET348";
  ...
  $mod.$main = function () {
    pas.browserconsole.ConsoleElementID = "pas2js-console-output";
