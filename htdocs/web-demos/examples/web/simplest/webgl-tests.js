  ...
  rtl.createClass(this,"TMyApplication",pas.wasihostapp.TBrowserWASIHostApplication,function () {
    ...
    this.DataLoaded = function (Event) {
      ...
      function DoStartWebAssembly() {
        ...
        $Self.StartWebAssembly("webgl-tests.wasm?random_suffix_to_avoid_cache=FPPTK788",true,rtl.createCallback($Self,"DoBeforeStart"),null);
      };
      var Xhr = null;
    ...
    this.DoRun = function () {
      var Xhr = null;
      var DataUrl = "";
      DataUrl = "webgl-tests_data.zip?random_suffix_to_avoid_cache=FPPTK788";
