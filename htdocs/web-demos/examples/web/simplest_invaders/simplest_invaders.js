  ...
  rtl.createClass(this,"TMyApplication",pas.wasihostapp.TBrowserWASIHostApplication,function () {
    ...
    this.DataLoaded = function (Event) {
      ...
      function DoStartWebAssembly() {
        ...
        $Self.StartWebAssembly("simplest_invaders.wasm?random_suffix_to_avoid_cache=LFPK090",true,rtl.createCallback($Self,"DoBeforeStart"),null);
      };
      var Xhr = null;
    ...
    this.DoRun = function () {
      var Xhr = null;
      var DataUrl = "";
      DataUrl = "simplest_invaders_data.zip?random_suffix_to_avoid_cache=LFPK090";
