...
'index'); ?> accept the command-line options listed below. <small>(Developers: <?php api_link('use this in your own programs', 'CastleWindow.TCastleWindow.html#ParseParameters'); ?>).</small>
