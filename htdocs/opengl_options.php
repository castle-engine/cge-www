...
<p>Most of the programs using <a href="index.php">Castle Game Engine</a> accept the command-line options listed below.

<p><small>(Developers: these options are handled automatically by CGE applications that follow our template and call <?php echo cgeRef('TCastleApplication.ParseStandardParameters', 'Application.ParseStandardParameters'); ?> from <code>castleautogenerated.pas</code>.)</small>
...
<p>See also <a href="common_options.php">general notes about options understood by our programs</a>.
