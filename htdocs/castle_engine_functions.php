        ...
        'sub' => array(
          ...
          'manual_mobile' => array('title' => 'Mobile and cross-platform games',
            'sub' => array(
              ...
              'manual_android_services' => array('title' => 'Android Services, like Google Play Games and In-App Payments (wiki)', 'url' => 'https://github.com/castle-engine/castle-engine/wiki/Android-Project-Services-Integrated-with-Castle-Game-Engine'),
              'manual_ios' => array('title' => 'iOS (wiki)', 'url' => 'https://github.com/castle-engine/castle-engine/wiki/iOS'),
              'manual_ios_services' => array('title' => 'iOS Services, like Apple Game Center (wiki)', 'url' => 'https://github.com/castle-engine/castle-engine/wiki/iOS-Services'),
