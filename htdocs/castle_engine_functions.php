    ...
    <div class="centered-download-wrapper">
        <div class="download jumbotron main-cge-download">
            <div class="download_platforms_list">
                ...
                <div class="download_platform"><a class="btn btn-primary btn-lg" href="' . $download_prefix . '-linux-arm.zip"><img src="' . CURRENT_URL . '/images/os_icons/raspberry_pi_32.png" alt="Raspberry Pi 32-bit (Linux Arm)" width="64" height="64"><br> Raspberry Pi<br>(32-bit, Linux Arm)</a></div>
                <div class="download_platform"><a class="btn btn-primary btn-lg" href="' . $download_prefix . '-linux-aarch64.zip"><img src="' . CURRENT_URL . '/images/os_icons/raspberry_pi_64.png" alt="Raspberry Pi 64-bit (Linux Aarch64)" width="64" height="64"><br> Raspberry Pi<br>(64-bit, Linux Aarch64)</a></div>
