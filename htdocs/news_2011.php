...
array_push($news,
    array('title' => 'Development news: shader pipeline improvements, 3DS/Wavefront/MD3 etc. are now converted to X3D, more',
          'year' => 2011,
          'month' => 6,
          'day' => 1,
          'short_description' => '',
...
'<p>Work on next view3dscene release continues. Some highlights from last news:</p>
...
<ul>
  ...
  <li><a href="http://vrmlengine.sourceforge.net/blender_stuff.php">Our Blender VRML/X3D exporter</a> updated to latest <a href="http://www.blender.org/">Blender 2.57</a>.</li>
