...
<ul>
  <li><p><tt>NurbsPatchSurface</tt> and <tt>NurbsCurve</tt></p></li>

  <li><p>Also basic VRML 97 NURBS nodes (defined in <i>VRML 97 Amendment 1</i>
    specification) are implemented: <tt>NurbsSurface</tt> and <tt>NurbsCurve</tt>.</p>

    <p>VRML 97 versions are similar, but not 100% the same as their X3D counterparts.
    For example, only X3D versions have <tt>xClosed</tt> fields.
    Only VRML 97 versions have <tt>ccw</tt> field.
