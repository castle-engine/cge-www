<?php
  ...
  common_header("Reference generated by pasdoc", LANG_EN, NULL, NULL);
?>

<p style="font-size: large; font-weight: bold">This is a reference of
<?php echo a_href_page('Kambi VRML game engine', 'kambi_vrml_game_engine'); ?>
 as generated by
<a href="http://pasdoc.sourceforge.net/">pasdoc</a>.

<p>Read reference in various formats:
<ul>
  <li><a href="apidoc/html/index.html">Online HTML reference</a>
  <li><?php echo current_www_a_href_size(
    'PDF reference',
    'apidoc/latex/docs.pdf'); ?>
  <li><?php echo current_www_a_href_size(
    'LaTeX version of the reference (was used to make PDF output)',
    'apidoc/latex/docs.tex'); ?>
<!--
  <li><a href="apidoc/latex/docs.html">Online HTML reference
