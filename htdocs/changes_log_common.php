...
begin
  ...
  <li><p>Other changes:</p>
    ...
    <ul>
      <li>
        <p>The <i>Lazarus integration of the engine is better</i>, with many old classes reworked as components. This is also tied to the previous change, because both <tt>TBase3D</tt> and <tt>TUIControl</tt> are descendants of <tt>TComponent</tt> &mdash; which means that important classes of our engine, like <tt>TVRMLGLScene</tt>, and also the cameras are now components that can be registered on Lazarus palette.</p>
