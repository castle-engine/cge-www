...
Log by default goes to <i>standard error output</i> (<code>StdErr</code>,
also known as <code>ErrOutput</code> in Pascal), which is
standard on Unixes (and avoids users asking questions <i>"where is the log
file"</i>). Be careful on Windows, for GUI applications the <code>StdErr</code>
may be undefined &mdash; you can either suggest users to run your program from
command-line to get the log, or you can pass a parameter to <code>InitializeLog</code>
