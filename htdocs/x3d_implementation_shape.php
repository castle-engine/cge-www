...
<ul>
  ...
  <li><p><?php echo x3d_node_link('PointProperties'); ?>.
    ...
    <p>Supported fields (below we link to Pascal API of them, see X3D specification linked above for more information):
    <ul>
      <li><p><?php echo cgeRef('TPointPropertiesNode.PointSizeScaleFactor', 'PointSizeScaleFactor'); ?>,
      <li><p><?php echo cgeRef('TPointPropertiesNode.PointSizeMinValue', 'PointSizeMinValue'); ?>,
      <li><p><?php echo cgeRef('TPointPropertiesNode.PointSizeMaxValue', 'PointSizeMaxValue'); ?>.
    </ul>

    <p>The effective scaling is multiplied by
    <?php echo cgeRef('TCastleRenderOptions.PointSize'); ?>
    which determines the nominal point size for the entire
    ...
    <ul>
      <li><p><a href="https://github.com/castle-engine/demo-models/blob/master/x3d/point_properties.x3dv">x3d/point_properties.x3dv in demo-models</a>
        (<a href="https://github.com/castle-engine/demo-models/blob/master/x3d/point_properties.x3dv_screenshot.png">reference screenshot</a>).
    ...
    <p>TODO: Not supported yet: <?php echo cgeRef('TPointPropertiesNode.Attenuation', 'Attenuation'); ?>
  </ul>
