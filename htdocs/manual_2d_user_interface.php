...
<ul>
  <li>
    <p><a href="https://github.com/eugeneloza/decoherence/issues/22#issuecomment-317891488">The process is described in detail here.</a>

  <li>
    <p>Note: In this particular case you <i>have</i> to use <code>image-to-pascal</code> to embed
    the image into the binary. That is because the loading image may be needed very early,
    and on some platforms (like Android) access to game data is not possible at that moment.
    So you <i>cannot</i> use <code>Theme.ImagesPersistent[tiLoading].Url := 'castle-data:/...';</code>
    in the initialization section of any unit.
</ul>
