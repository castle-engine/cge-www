...
<ol>
  <li><a href="https://castle-engine.sourceforge.io/compositing_shaders_doc/html/">"Compositing Shaders in X3D" documentation, HTML version</a>. This is my Ph.D. thesis, enjoy :)
    <br>(Note that the Ph.D. thesis was not yet formally "defended". Mostly due to my lack of time to finalize it...)
  </li>
  <li><a href="https://castle-engine.sourceforge.io/compositing_shaders_doc/compositing_shaders_doc.pdf">"Compositing Shaders in X3D" documentation, PDF version</a>. Exactly the same content as above HTML version, just in PDF &mdash; probably much better for printing.</li>
