...
<a>glc</a>, under Windows there is <a>fraps</a> and many others.
...
ffmpeg (our view3dscene does this automatically). Although this is
...
<p>IOW, you manually force the current time of the scene/camera to
...
can remove the "MainScene.IncreaseTime" call, if you know that your
...
animation in VRML/X3D, you can remove the "Camera.Idle" line.

<p>FrameTime is in seconds, as both TCastleSceneCore.IncreseTime and
TCamera.Idle take it's time argument in seconds. But don't worry, this
is a float, so actually it honors fractions of seconds as well. So
