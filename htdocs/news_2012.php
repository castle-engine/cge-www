...
'<p>Sorry, still no new release... But, as usual, we have many new features to announce for the upcoming <a href="http://castle-engine.sourceforge.net/engine.php">Castle Game Engine</a> 4.0.0 :) For starters, a little movie with explosions fun:</p>
...
<ol>
  ...
  <li><p>Our <a href="http://castle-engine.sourceforge.net/blender.php"><b>Blender X3D exporter</b></a> updated for Blender 2.64a.</p>
    <p>New <a href="http://castle-engine.sourceforge.net/blender.php"><b>KAnim exporter</b> for Blender 2.64a</a> added. For the same reason as a couple of years ago (Blender standard X3D exporter still cannot export animations) we still need it.</p></li>
  ...
  <li><p><b>Levels improvements</b>:</p>
    <ol>
      ...
      <li>Magic "margin" parameter around sectors removed. We now just look at waypoint\'s bounding box. See <a href="http://castle-engine.sourceforge.net/castle-development.php">castle-development</a> for notes about sectors/waypoints for user, and see <tt>TGameSceneManager.LoadLevel</tt> for developer docs.</li>
