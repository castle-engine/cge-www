...
<ol>
  <li><p>Many improvements to
    <a href="https://castle-engine.io/manual">engine tutorial</a>,
...
<ol>
  ...
  <li><p><b>Screen effects cooperate now wit multi-sampling (anti-aliasing)</b>. Previously, any screen effect (like SSAO, or <a href="https://castle-engine.io/view3dscene.php">view3dscene</a> effects, or effects in VRML/X3D files like <code>demo_models/screen_effects/</code> from <a href="https://castle-engine.io/demo_models">demo models</a>) was disabling anti-aliasing.</p>
  ...
  <li><p>Victor Amat send us some very nice 3D model of <b><a href="https://en.wikipedia.org/wiki/Barcelona_Pavilion">German Pavillion in the Universal Expo of Barcelona of 1929</a></b>, see the screenshots on the right, with very nice water and reflections.
    ...
    <p>And, also from Victor Amat, a nice <b>soft shadows demo based on shadow maps</b>. It\'s an adaptation from nVidia SDK 9, but using a PoissonDisk sampler instead of a jittered grid pattern. You can see a screenshot from it on the side. The source X3D file is inside <a href="https://castle-engine.io/demo_models">demo models</a> SVN, see subdirectory <code>demo_models/shadow_maps/soft_shadow_poisson_sampling/</code>. Thousand thanks!

  <li><p>The X3D feature to specify <b>height of the tallest object you can climb</b> inside <code>NavigationInfo.avatarSize[2]</code> field is now correctly supported. The demo model is inside <a href="https://castle-engine.io/demo_models">demo models</a> (open <code>demo_models/navigation/avatar_climb_stairs.x3dv</code>; only in SVN for now, until next release).</p></li>

  <li><p><b><code>VisibilitySensor</code> node</b> is implemented (looking only at frustum for now). See the testcase sensors_environmental/visibility_sensor.x3dv in <a href="https://castle-engine.io/demo_models">demo models</a> SVN.
