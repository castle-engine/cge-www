...
<li>More item weapon behavior easily available: you can now define short-range attack and missile firing (with ammo or not) fully inside TItemWeaponKind (and related resource.xml file), no need for a single line of code.
