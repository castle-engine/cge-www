...
<ul>
  <li><?php echo a_href_page('Engine API reference (generated by pasdoc)',
    'reference') ?>.</li>
  <li><?php echo a_href_page("Engine documentation",
    'engine_doc'); ?> (more general overview of how the engine works).</li>
</ul>
