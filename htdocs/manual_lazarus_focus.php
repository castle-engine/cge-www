...
even other <code>TCastleControlBase</code> on the same form, may want to handle
...
<p>There's no visual indicator when <code>TCastleControlBase</code> has focus
(as there's
...
<ol>
  <li><p>In the simplest cases, the problem simply doesn't exist, as
    <code>TCastleControlBase</code> is the only thing on your form able to receive focus
  ...
  <li><p>If you want to use other focusable controls, it's really up to you
    ...
    <code>TCastleControlBase</code> by the Tab key or clicking with mouse on other
    controls.</p>
    ...
    <ol>
      ...
      <li><p>You may want to draw some visual indication, like a border around
        <code>TCastleControlBase</code>, when it's focused. Actually, our <code>TCastleControlBase</code>
