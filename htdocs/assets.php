...
<div class="row">
  <?php gallery_link('OpenGameArt.org',
    'Good quality art (3D, 2D, sounds) uploaded by various artsts on clear open-source licenses.
  ...
  <?php gallery_link('Kenney',
    'Lots of high quality art (sprites, 3D models, sound effects) on a public domain ("do what you want") license.',
    'assets_kenney.png',
    'https://kenney.nl/');
  ?>

  <?php gallery_link('Sketchfab glTF models',
    'Good quality 3D models, in glTF format, uploaded by various arists. Some free (on clear licenses, like <i>Creative Commons</i>), some paid.',
    'assets_sketchfab.png',
    'https://sketchfab.com/features/gltf');
  ?>

  <?php gallery_link('Blend Swap',
    'Good quality 3D models in <a href="https://www.blender.org/">Blender</a> (which you can <a href="creating_data_blender.php">export to glTF easily</a>). Uploaded by various artists. All on <i>Creative Commons</i> licenses.',
