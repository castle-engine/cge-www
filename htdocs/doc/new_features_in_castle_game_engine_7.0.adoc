...
* joints,
* layers,
* updates 3rd-person navigation component that can now work with physics,
...
* Full support tested for Delphi >= 10.2.1, up to the latest 11.x (with plans to support some even older versions, see https://castle-engine.io/supported_compilers.php#section_versions[Delphi versions supported]).
--
* Easily activate https://castle-engine.io/wp/2022/10/03/easy-shadows-in-editor-at-design-time-too-by-shadow-volumes-and-shadow-maps-are-coming-as-well/[shadows], just select checkbox `Shadows` at the light source to use shadow volumes.
+
--
...
* Note: We plan to expose also our _shadow maps_ in a similar easy-to-use fashion in future releases.
--
...
* https://castle-engine.io/wp/2023/06/30/big-renderer-improvements-correct-and-automatic-blending-sorting-more-powerful-batching-now-cross-scene-easier-and-more-reliable-occlusion-culling-and-occlusion-sorting/[Correct and automatic blending sorting, more powerful batching (now cross-scene), easier and more reliable occlusion culling and occlusion sorting]
--
* Many editor UX improvements. The most important ones:
+
--
* Modern color picker dialog to adjust colors as HSV, RGB, hex, show Pascal code, auto-apply.
...
* Lots of https://castle-engine.io/android[Android] improvements: Google Play Games, OpenAL, AdMob, building APIs upgrades. See https://castle-engine.io/wp/2023/08/06/android-upgraded-everything-google-play-services-openal-admod-api-level-gradle/[news].
