 ...
 ** https://github.com/castle-engine/castle-engine/tree/master/examples/3d_rendering_processing/shader_override[shader_override] - overriding shaders with your own
