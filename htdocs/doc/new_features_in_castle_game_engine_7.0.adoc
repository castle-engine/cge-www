...
* MD3 support improvements: we now automatically load `animation.cfg`, so playing particular MD3 animations is trivial, just use our `PlayAnimation` method. Also optimized loading. See https://castle-engine.io/creating_data_model_formats.php#section_md3[MD3 support docs].
