...
We plan to release version _7.0_ (stable) at the end of this year, 2022 (with an unofficial but hard deadline for 7.0 release at _Christmas 2022_ :) ).

Maybe there will be another _alpha_ or _beta_ release in 2022 before the full 7.0.

See https://castle-engine.io/wp/2022/01/01/summary-of-2021-plans-for-2022/[our plans for 2022] for details what we plan. And https://castle-engine.io/roadmap[our roadmap] for more long-term goals (not just in 7.0). Immediate future plans after _7.0-alpha.2_ release are:

- Integrate physics with joints from _Andrzej Kilijański_, see link:https://github.com/castle-engine/castle-engine/pull/394[PR] and link:https://www.youtube.com/watch?v=mNgBttV5DuA[teaser movie].
 ...
 ** cgeref:TUIState[] is used extensively, in almost all examples, naturally splits code into different states. Has new https://castle-engine.io/wp/2021/05/01/introducing-tuistate-designurl-designpreload-designedcomponent/[simpler API to load design], https://castle-engine.io/manual_state_events.php[docs], https://castle-engine.io/wp/2021/04/03/better-code-navigation-new-units-states-creation-new-ways-to-open-source-code-for-editing-better-integration-with-lazarus-project/[creating new state in editor].
