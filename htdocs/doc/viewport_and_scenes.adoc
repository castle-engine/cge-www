...
NOTE: It's usually simplest to create an instance of cgeref:TCastleTransformReference[] by right-clicking on the source cgeref:TCastleTransform[] in the hierarchy and choosing _"Duplicate Linked (TCastleTransformReference)"_ from the context menu.
