# Viewport with scenes, camera, navigation: overview
include::common.adoc[]
...
## Using the viewport in Castle Game Engine editor
...
TODO: add subchapters for everything else in current manual, in particular how to use scenes from code.
