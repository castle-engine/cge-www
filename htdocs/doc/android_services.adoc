...
image:https://castle-engine.io/images/thumb_size/android-components-icons.png[float="right",link=https://castle-engine.io/images/original_size/android-components-icons.png,role="screenshot"]
