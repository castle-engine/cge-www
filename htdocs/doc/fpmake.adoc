...
* https://github.com/castle-engine/castle-engine/blob/master/examples/instantfpc/instant_fpc_test_open_window - open a window, with text taken from the 1st command-line parameter, using `CastleWindow` and cgeref:TCastleLabel[].
