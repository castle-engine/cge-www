...
[NOTE]
====
Admittedly, in this case, it would be simpler to add these 2 walls to the `road.gltf` model in Blender. But in general, this technique is extremely powerful to generate 3D scenes following any algorithm!
====
