...
* `<input-filename>`
+
3D model filename. Any format link:creating_data_model_formats.php[supported by our engine is OK].
+
...
See also link:common_options.php[notes about command-line options for all my programs].
