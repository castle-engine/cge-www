...
* Can use any LCL backend, in particular it allows to use Cocoa on macOS. This is the only way for now to have `TCastleWindow` have a native look on macOS. See https://castle-engine.io/macosx_requirements.php[CGE on macOS notes].
