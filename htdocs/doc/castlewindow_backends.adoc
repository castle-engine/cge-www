...
* Can use any LCL backend, in particular it allows to use Cocoa on macOS. This is the only way for now to have `TCastleWindow` have a native look on macOS. See link:macos[macOS].
