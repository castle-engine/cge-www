...
Linux:: You should install https://www.freepascal.org/[FPC] first. It is usually easiest to install a package called `fpc` using your package manager. Then download and install link:https://www.lazarus-ide.org/[Lazarus package] for Linux.
