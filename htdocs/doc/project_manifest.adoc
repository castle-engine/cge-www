...
* `detect_memory_leaks` attribute activates link:detecting_memory_leaks_using_heaptrc[memory leak detection using HeapTrc]. It is only supported by FPC right now.
