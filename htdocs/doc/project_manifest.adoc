...
+
NOTE: It is possible to also define symbols using custom option like `-dMY_CUSTOM_SYMBOL`. Both FPC and DCC support this command-line option. But we recommend `<defines>`, as more future-proof.
