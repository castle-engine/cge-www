...
+
See FPC docs: https://wiki.freepascal.org/FPC_Unicode_support[Unicode support], https://wiki.freepascal.org/Unicode_Support_in_Lazarus[Unicode support in Lazarus], https://wiki.freepascal.org/Character_and_string_types[Character and string types].
