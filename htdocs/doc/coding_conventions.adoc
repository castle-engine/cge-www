...
`PascalCase` means that the first character of each word is capatalized. Use it for all identifiers.
...
WARNING: The keywords `nil`, `true`, `false` are stil lowercase.
