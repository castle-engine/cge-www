...
cgeimg::block[
  tremulous_editor.png|Tremulous animated MD3 in Castle Game Engine editor,
...
+
They can be used together with our link:wp/2020/10/09/attach-objects-to-animated-bones-like-weapon-in-characters-hand-by-exposetransforms/[ExposeTransforms] mechanism to attach things to them, e.g. you can attach a weapon model to a specific place in the character. This allows the weapon to realistically follow the movement of the character's hands.
