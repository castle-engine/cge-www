...
Use cgeref:TCastleViewport[]. Add cgeref:TCastleViewport[] control to the window, and inside it draw things by creating cgeref:TCastleScene[] instances.
 ...
 ** The cgeref:TCastleScene[] is incredibly versatile. You can load game models from files. E.g. Spine animations, Blender models etc. You can play animations. Everything described on http://castle-engine.io/manual_scene.php works.
...
* Manual:
 ** link:manual_state_events.php[Designing user interface and handling events (press, update) within the state] documents basic image display using cgeref:TCastleImageControl[].
