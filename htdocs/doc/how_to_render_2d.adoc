...
* Manual:
 ** link:view_events[Designing user interface and handling events (press, update) within the state] documents basic image display using cgeref:TCastleImageControl[].
