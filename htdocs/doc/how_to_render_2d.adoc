...
* You can use batching using cgeref:BatchingBegin[] and cgeref:BatchingEnd[]. It works completely automatically by grouping rendering the same image many times into one draw call.
