...
cgeimg::block[
  fps_editor.png|Castle Game Engine editor designing examples/3d_games/explore_impressive_castle,
  fps_game_2.png|examples/3d_games/explore_impressive_castle run from editor
]
