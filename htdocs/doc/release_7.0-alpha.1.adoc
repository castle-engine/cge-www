...
- link:viewport_and_scenes#section_camera[Better API for viewports and cameras in `TCastleViewport`]
...
- link:data_settings[CastleSettings.xml file support]
...
- link:optimization[Many optimizations and profiling features]
 ...
 ** Everything described in the updated optimization docs on https://castle-engine.io/optimization
* Rendering:
