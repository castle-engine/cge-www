...
+
This often happens because you use a lot of texture memory. Use cgeref:TextureMemoryProfiler[] to analyze your texture memory usage. Use https://castle-engine.io/optimization#section_textures[various optimization hints related to textures] to decrease texture memory usage.
...
* See the https://castle-engine.io/optimization[manual about optimization] for more ideas.
