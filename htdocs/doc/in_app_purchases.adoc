...
This is a step-by-step instruction how to implement _in-app purchases_ (for Android and iOS) using CGE cgeref:CastleInAppPurchases[] unit and https://castle-engine.io/apidoc-unstable/html/CastleInAppPurchases.TInAppPurchases.html[TInAppPurchases] class.
