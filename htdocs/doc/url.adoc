...
_On the link:web[]_, beware of the _CORS (Cross-Origin Resource Sharing)_ policy that may prevent your application from downloading data from other domains. See link:web#http_requests[HTTP requests on the web and CORS] for more information.
