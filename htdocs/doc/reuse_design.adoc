...
- https://github.com/castle-engine/castle-engine/tree/master/examples/2d_games/space_shooter[examples/2d_games/space_shooter] (spawning bullets, rocks, explosions)
