...
Installing _Castle Game Engine_ packages in Delphi is necessary to

- link:control_on_form[Register TCastleControl component, that you can drop on a VCL or FMX form].
