...
<?php echo cgeRef('TCastleUserInterface'); ?>
 ...
 <?php echo cgeRef('TIUState'); ?> descendant
...
<ul>
  <li><?php echo cgeRef('TCastleLabel'); ?> - Label with text. As with all our text controls, the font family and size is customizable (see <a href="manual_text.php">chapter about text</a>). May have a frame. May be multiline. May contain some <?php echo cgeRef('HTML tags'); ?>.</li>
