...
** For example you can attach a weapon carried by a player in FPS game as a child of camera. See https://github.com/castle-engine/castle-engine/tree/master/examples/3d_games/explore_impressive_castle[examples/3d_games/explore_impressive_castle] demo.
