...
After installing https://marketplace.visualstudio.com/items?itemName=castle-engine-team.castle-engine[Castle Game Engine in VS Code] extension, all you need to do is go to the extension settings and configure FPC, Lazarus paths to make it work.
