...
+
For best results, sort your opaque shapes (that write to depth buffer) in the order "from front to back". That's because you want to render the "things that may obscure other things" earlier.
+
