...
[source,pascal]
----
include::modern_pascal_code_samples/hello_world.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/functions_primitives.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/loops.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/for_in_list.lpr[]
----
+
...
[source,pascal]
----
include::modern_pascal_code_samples/myunit_test.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/inheritance.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/is_as.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/exception_finally.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/method_calls_inheritance_1.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/method_calls_inherited.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/without_virtual_methods.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/with_virtual_methods.lpr[]
----
...
NOTE: This dirty trick (officially allowing the method to be used with `Self` equal `nil`) is possible only for non-virtual methods. And as long as `Self = nil` is possible, the method cannot call any virtual methods or access any fields, as these would crash with acces violation when called on a `nil` pointer. See the sample code https://github.com/michaliskambi/modern-pascal-introduction/blob/master/code-samples/method_with_self_nil.lpr[method_with_self_nil.lpr]. We discourage from using this trick in your own code (for virtual or non-virtual methods) as it is counter-intuitive to normal usage, in general all instance methods should be able to assume that they work on valid (non-nil) instance and can access fields and call any other methods (virtual or not).
...
[source,pascal]
----
include::modern_pascal_code_samples/file_stream.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/generics_lists.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/generics_sorting.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/generics_dictionary.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/generics_object_dictionary.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/persistent.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/callbacks.lpr[]
----
* A method: declare with `of object` at the end.
+
[source,pascal]
----
include::modern_pascal_code_samples/callbacks_of_object.lpr[]
----
+
...
[source,pascal]
----
include::modern_pascal_code_samples/generics.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/generic_functions.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/records.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/operator_overloading.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/operator_overloading_classes.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/operator_overloading_records.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/operator_overloading_records_lists.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/static_class_method.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/class_properties.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/exception_in_constructor_test.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/interfaces_corba_test.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/gen_guid.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/interfaces_com_with_ref_counting.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/interfaces_com_test.lpr[]
----
...
[source,pascal]
----
include::modern_pascal_code_samples/interface_casting.lpr[]
----
