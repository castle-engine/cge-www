...
[WARNING]
====
If you have both cgeref:TCastleWalkNavigation[] and cgeref:TCastleTouchNavigation[] as children of the same cgeref:TCastleViewport[], make sure to **put cgeref:TCastleTouchNavigation[] in front of cgeref:TCastleWalkNavigation[]**. Otherwise, cgeref:TCastleWalkNavigation[] will capture all touches and cgeref:TCastleTouchNavigation[] will not work.
