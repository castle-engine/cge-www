...
Files and XML utilities. Also downloading from the network, and processing of URLs. See link:pass:[https://castle-engine.io/tutorial_network.php][tutorial about network and downloading].

_Depends on_: everything above (that is, units in "base" group).

==== audio

Sound files loading, sound playback (including 3D sound) using OpenAL, processing of sound files. See link:pass:[https://castle-engine.io/tutorial_sound.php][tutorial about sound].
...
Parsing and executing expressions and programs in the  link:pass:[https://castle-engine.io/castle_script.php][CastleScript language].
