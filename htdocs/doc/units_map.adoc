...
Files, URLs, XML utilities, downloading files from the network. See link:url[manual about URL and downloading].
...
Parsing and executing expressions and programs in the  link:castle_script[CastleScript language].
