...
When you run our https://castle-engine.io/manual_editor.php[editor], create a _"New Project"_ and use template _"2D Game"_. This shows a viewport with multiple Spine scenes. A Spine scene is just a cgeref:TCastleScene[] instance and you add it to cgeref:TCastleViewport[] to make it visible, animated etc.
