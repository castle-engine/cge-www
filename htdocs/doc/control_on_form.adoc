...
You can load a design (file `xxx.castle-user-interface`) and you can use cgeref:TUIState[] within the cgeref:TCastleControl[], just as with cgeref:TCastleWindow[]. You can add new _state_ using CGE editor, or just define a new unit like this:
