...
+
If you switch between platforms or configurations, you can repeat this step for each combination of platform and configuration you need. Or just copy-paste the paths into "parent" settings in _"All Configurations - All Platforms"_ in _"Delphi Compiler"_ page.
--
