...
--
cgeimg::block[
  lazarus-install-31.png|castle_engine_lcl: Choose the file,
  lazarus-install-32.png|castle_engine_lcl: Install,
  lazarus-install-33.png|castle_engine_lcl: Confirm Lazarus rebuild
]
--
+
