[TCastleWindowBase](https://castle-engine.io/apidoc-unstable/html/CastleWindow.TCastleWindowBase.html) class represents a window suitable for *Castle Game Engine* rendering.
