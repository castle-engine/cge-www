...
- To compile the applications, install also GTK and OpenGL development libraries. The exact list of packages to install, for various popular Linux distributions, is documented on link:compiling_from_source#section_Linux,_FreeBSD[compiling from source (section about Linux)].
--
