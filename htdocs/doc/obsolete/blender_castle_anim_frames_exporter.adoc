...
To export _any_ kind of animation from Blender, use the exporter to our link:castle_animation_frames[Castle Animation Frames format]. The `.castle-anim-frames` files can be read by our engine and will play animations.
