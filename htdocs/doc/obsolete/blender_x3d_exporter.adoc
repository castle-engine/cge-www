...
* *Points and spot lights are exported OK. Directional light ("sun") is incorrect in official exporter version.* Use our exporter version from https://castle-engine.io/creating_data_blender.php to have `DirectionalLight` working OK.
