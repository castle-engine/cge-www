# Alternative ways to download and install
include::common.adoc[]

While you can link:/[just download the latest engine from our webpage], we also support some alternative installation methods:
...
Castle Game Engine is available in Debian and Ubuntu throught the official packages, albeit in slightly outdated versions.
