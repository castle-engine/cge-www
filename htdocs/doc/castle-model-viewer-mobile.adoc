...
cgeimg::block[
  castle-model-viewer-feature.png|Castle Model Viewer Mobile - Dungeon in Examine Mode,
  castle-model-viewer-1.jpg|Castle Model Viewer Mobile 1,
  castle-model-viewer-2.jpg|Castle Model Viewer Mobile 2,
  castle-model-viewer-3.jpg|Castle Model Viewer Mobile 3,
  castle-model-viewer-4.jpg|Castle Model Viewer Mobile 4,
  castle-model-viewer-5.jpg|Castle Model Viewer Mobile 5,
  castle-model-viewer-6.jpg|Castle Model Viewer Mobile 6,
  castle-model-viewer-7.jpg|Castle Model Viewer Mobile 7
]
...
This is a mobile version of link:castle-model-viewer[Castle Model Viewer], sharing the capabilities with the desktop version but with UI streamlined for mobile devices. It is available now for Android, soon also for iOS.
