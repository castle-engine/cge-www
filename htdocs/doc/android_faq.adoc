...
+
When you design using link:editor[CGE editor], it will automatically use `castle-data:/xxx` URLs.
...
* In link:editor[CGE editor], change _"Run -> Package Format"_ to _"Android App Bundle (AAB)"_.
