...
NOTE: You can also use https://developer.android.com/studio[Android Studio] to open and run your Android project (stored in `<your-project>/castle-engine-output/android/`). This is a straightforward way to debug your application in many cases.
