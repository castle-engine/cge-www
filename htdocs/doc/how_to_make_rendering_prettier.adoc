...
This page is the opposite of the manual page manual_optimization.php[How to optimize your games] :)

* Use *Physical-Based Rendering (PBR)*.
+
The easiest way to use PBR is by using link:gltf[glTF] format for your assets. glTF by default uses PBR materials. You can design and export glTF with PBR e.g. using creating_data_blender.php[Blender].
+
