...
This page is the opposite of the manual page link:optimization[How to optimize your games] :)
...
* Use link:screen_effects[screen effects (post-processing)].
* Use effects like link:mirror_plane[mirrors] and link:shadow_maps[shadows].
