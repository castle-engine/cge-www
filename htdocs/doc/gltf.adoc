...
cgeimg::float[view3dscene_outlines.png|glTF model from Sketchfab,view3dscene_mousey.png|glTF model,view3dscene_steampunk_gltf.png|glTF model from Sketchfab]
