...
This is available using cgeref:TCastleSceneCore.ExposeTransforms[TCastleScene.ExposeTransforms]. You can "expose" a bone transformation as cgeref:TCastleTransform[] child and attach there a scene. See https://castle-engine.io/wp/2020/10/09/attach-objects-to-animated-bones-like-weapon-in-characters-hand-by-exposetransforms/ .
