...
== Guidelines to use AI successfully
...
== Guidelines to successfully develop games using Castle Game Engine, with or without AI

Whether you use AI or not, common recommendations apply:

- Learn to use the engine by https://www.youtube.com/@CastleGameEngine[watching our tutorials], https://castle-engine.io/bad_chess[reading our tutorials], and https://castle-engine.io/manual_intro.php[following our manual].
