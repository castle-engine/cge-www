...
- **AI-generated larger pieces of code / documentation are often wrong.** They confuse you (suggesting further work in a wrong direction), they show hallucinated or deprecated APIs, they do not use recommended approaches (e.g. AI often puts everything in one big program file, which makes application non-link:cross_platform[cross-platform] and ignores our link:views[] concept to organize applications), they do not understand the platform-specific and compiler-specific language nuances etc.
