...
- And the new components are just `TComponent`, so they will share usual `TComponent` ownership, not ref-counting special for X3D nodes (and sometimes needing special treatment shown above).
