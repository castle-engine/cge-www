...
include::common.adoc[]
:description: Using game controllers, like gamepads (XBox Controllers), Nintendo Switch controllers (Joy-Cons), joysticks.
//:cge-social-share-image: todo_screen_with_gamepad.png
...
// TODO: screenshots / photos from examples below

== Examples

We provide several examples that allow you to test this support:

// TODO: master branch, once merged
// TODO: screenshot
- The example https://github.com/castle-engine/castle-engine/tree/gamepads-improve-api/examples/game_controllers[examples/game_controllers] allows you to test all controller buttons and axes.
...
- Our example https://github.com/castle-engine/castle-engine/blob/gamepads-improve-api/examples/fps_game/[examples/fps_game] also supports gamepads, using the most standard arrangement for 3D FPS games, as explained link:#walk_navigation[later in this document].
...
Read cgeref:TGameControllers.Initialize[Controllers.Count] and cgeref:TGameControllers.Initialize[Controllers.Items] (default array property) to access the list of connected controllers. Like this:
...
begin
  // Controllers[I] is a TGameController instance
...
This is really everything that the https://github.com/castle-engine/castle-engine/blob/gamepads-improve-api/examples/fps_game/[examples/fps_game] game is doing to support gamepads: https://github.com/castle-engine/castle-engine/blob/966bc9b04d00c69d5ad97d720e8be94c55bb652c/examples/fps_game/code/gameviewplay.pas#L90-L91[see here].
...
- Maybe: XInput backend on _Windows_. (What are the practical gains over the current _MMSystem_?)
--
