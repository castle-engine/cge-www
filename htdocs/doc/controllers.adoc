...
- The basic example in https://github.com/castle-engine/castle-engine/tree/master/examples/game_controllers[examples/game_controllers] allows you to test all controller buttons and axes.

- https://github.com/castle-engine/castle-engine/tree/master/examples/3d_games/walking_adventure/[Walking Talking Adventure demo (examples/3d_games/walking_adventure)] shows how to use game controllers in practice, in a simple 3D demo game where you walk and talk with NPCs.

- Our example https://github.com/castle-engine/castle-engine/tree/master/examples/3d_games/explore_impressive_castle[Explore Impressive 3D Castle (examples/3d_games/explore_impressive_castle)] also supports gamepads, using the most standard arrangement for 3D FPS games, as explained link:#walk_navigation[later in this document].
...
This is really everything that the https://github.com/castle-engine/castle-engine/tree/master/examples/3d_games/explore_impressive_castle[Explore Impressive 3D Castle (examples/3d_games/explore_impressive_castle)] demo is doing to support gamepads: https://github.com/castle-engine/castle-engine/blob/34a2a41b67efb6afcdbe12628694738fddba2241/examples/3d_games/explore_impressive_castle/code/gameviewplay.pas#L90-L91[see here].
