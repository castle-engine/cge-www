...
If you want to use game controllers with anything that exposes inputs as cgeref:TInputShortcut[], it's easy. The cgeref:TInputShortcut[] have a cgeref:TInputShortcut.Bindings[] list and can react to controller buttons or axes.
