...
- Snapshots (version 4.3.0, soon to be released as 4.4.0): https://jenkins.castle-engine.io/public/builds/view3dscene/

- Last stable (version 4.2.0): https://github.com/castle-engine/castle-model-viewer/releases/tag/v4.2.0
...
Source code is available on GitHub in https://github.com/castle-engine/castle-model-viewer[castle-model-viewer repository].
