...
// TODO: DEMO
. Another solution is to move the camera. You can adjust `Viewport.Camera.Translation`. If you move the camera by `(-Viewport.Camera.Orthographic.EffectiveWidth / 2, -Viewport.Camera.Orthographic.EffectiveHeight / 2)` then the asset will be in the middle of the viewport.
// TODO: DEMO
