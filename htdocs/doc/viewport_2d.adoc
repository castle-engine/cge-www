...
Consult the engine examples, like:

- https://github.com/castle-engine/castle-engine/tree/master/examples/2d_games/platformer[examples/2d_games/platformer]

- https://github.com/castle-engine/castle-engine/tree/master/examples/2d_games/space_shooter[examples/2d_games/space_shooter]

...for game demos following this approach.
...
You can use any link:model_formats[supported model format].
...
See link:blending[blending] for more details about blending, and see link:alpha_bleeding[alpha bleeding] for details about how to prepare your images to behave correctly with blending.
