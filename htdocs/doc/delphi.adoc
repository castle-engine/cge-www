...
The engine is fully compatible with _{Cpp} Builder_. The complete engine class API is available from {Cpp} in a natural way. You can use `TCastleWindow` or `TCastleControl` from {Cpp}, just like from Pascal. See https://castle-engine.io/wp/2023/12/01/full-compatibility-with-c-builder/[the details in this article].
