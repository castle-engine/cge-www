...
We can load and save the IFC entities listed in API docs of cgeref:CastleIfc[] unit. This includes over 120 classes reflecting the IFC specification.
...
- wireframe box: cgeref:TIfcBoundingBox[] in IFC, cgeref:TBoxNode[] in X3D (with cgeref:TShapeNode.Shading[] set to cgeref:shWireframe[])
