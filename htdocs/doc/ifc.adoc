...
- extrusion of a cross-section along a direction: cgeref:TIfcExtrudedAreaSolid[] in IFC, mesh (cgeref:TIndexedQuadSet[] for sides, cgeref:TIndexedFaceSet[] for top/bottom caps) in X3D
//+
