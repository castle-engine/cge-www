...
* Ready instructions to use
** link:github_actions[GitHub Actions] to automatically build CGE projects.
** link:gitlab_ci[GitLab CI] to automatically build CGE projects.
** link:github_actions[Jenkins] to automatically build CGE projects.
