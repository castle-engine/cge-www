...
* https://castle-engine.io/wp/2023/04/08/web-target-progress-and-plans/[WebGL (FPC can compile to WebAssembly)]
...
* You can write model conversion utilities. Our link:castle-model-viewer[Castle Model Viewer] allows to convert various models to X3D.
...
* All paths are expressed as URLs with some special CGE protocols, see link:manual_network.php[networking].
