...
cgeimg::block[
  view3dscene_gltf_helmet.png|Helmet glTF sample,
  view3dscene_outlines.png|Village scene with outlines from Sketchfab\, https://sketchfab.com/3d-models/ftm-0970f30574d047b1976ba0aa6f2ef855 by Luis Fernandez\, https://sketchfab.com/luyssport,
...
* https://github.com/Kagamma/cge-effekseer[Effekseer Integration]: Integration with <a href="https://effekseer.github.io/en/">Effekseer</a>, a full-featured open-source particle effect creation tool. By _Trung Le (Kagamma)_.
+
