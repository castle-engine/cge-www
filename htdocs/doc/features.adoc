...
* link:shaders[Shader effects] to define effects using GLSL that enhance existing engine rendering. See https://github.com/castle-engine/castle-engine/tree/master/examples/viewport_and_scenes/shader_effects[examples/viewport_and_scenes/shader_effects] example. You can write own effects easily using _OpenGL Shading Language_.
+
cgeimg::block[
