...
* link:https://github.com/castle-engine/castle-engine/tree/master/examples/3d_rendering_processing/multiple_viewports[multiple_viewports] example. Shows a window split into 4 viewports, all showing the same scene, but with a bit different effects.
