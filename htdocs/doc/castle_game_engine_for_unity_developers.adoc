...
Our manual documents cgeref:TCastleScene[] and cgeref:TCastleTransform[] features: https://castle-engine.io/manual_load_3d.php , https://castle-engine.io/manual_scene.php . Basically you can do stuff like
