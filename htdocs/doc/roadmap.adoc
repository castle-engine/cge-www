...
## User interface (or any other simple property of CGE component) animation in editor
...
- key-frames
- key-values
- support a few most common options: animating floats, vec2, vec3
- configurable target component (TComponent)
- configurable target property (string? and get/set property using RTTI)
- easing (e.g. to make "bouncing" effect at the end of animation), https://easings.net/ https://developer.mozilla.org/en-US/docs/Web/CSS/easing-function
