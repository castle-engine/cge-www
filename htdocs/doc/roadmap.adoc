...
* Approach:
+
We have a simple example code that shows how you can start a new renderer: see link:https://github.com/castle-engine/castle-engine/blob/master/examples/research_special_rendering_methods/new_renderer_skeleton/[examples/research_special_rendering_methods/new_renderer_skeleton/]. This is great for testing initial implementation, before we have a "pluggable" architecture.
...
- https://docwiki.embarcadero.com/RADStudio/Sydney/en/Tutorial:_Using_Tasks_from_the_Parallel_Programming_Library
