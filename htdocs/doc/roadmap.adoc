...
## (IN PROGRESS) Possibility to reorder/merge all shapes, across all scenes (better blending, better batching)

*In progress on https://github.com/castle-engine/castle-engine/tree/shapes-rendering-2 branch.*
