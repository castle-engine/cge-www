...
### Optimized animations (OptimizeExtensiveTransformations) just out-of-the-box
...
- _(DONE NOW)_ cgeref:InternalFastTransformUpdate[] enable by default and make it work regardless of what is animated.
