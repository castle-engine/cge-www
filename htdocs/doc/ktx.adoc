...
You may find example KTX images inside our link:demo_models[demo models]. Also https://github.com/KhronosGroup/KTX-Software[KTX-Software] has some samples (look in `tests` subdirectory).
