...
See the TODO[main news announcement on blog for the summary]. This page serves as a detailed release notes.
...
* https://castle-engine.io/https://castle-engine.io/physics[Physics]. New components for colliders and rigid bodies, ability to run physics simulation in the editor, joints, layers, forces.
