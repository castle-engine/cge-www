...
In Delphi IDE, go to _"Options" -> "Deployment" -> "Connection Profile Manager"_. Add a new connection to the Linux machine. You need to provide the IP address of the Linux machine (use e.g. `ip a` on Linux to see your current IP).
