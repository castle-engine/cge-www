...
NOTE: This can possibly be made easier, if we switch to building using `msbuild` from our link:build_tool[build tool], instead of calling Delphi `dccXXX` compiler executable directly.
