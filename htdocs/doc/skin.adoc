...
- Enable importing https://docs.blender.org/manual/en/latest/addons/import_export/anim_bvh.html[BVH] files. As we already support skinning and we have proved we can read motion capture data, this is a logical next step.