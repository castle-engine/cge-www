...
+
--
- increase cgeref:TCastlePointLight.Intensity[] (don't be afraid to experiment with really large values, like 100 or even 1000),
- or set cgeref:TCastlePointLight.Attenuation[] to `0 0 0` (this makes unrealistic light that shines uniformly in all directions, without attenuation),
- or add a new cgeref:TCastleDirectionalLight[] to make everything brighter (this is a light that shines in a given direction, like a sun). Maybe you will not need the point light anymore -- you can remove it.
--
