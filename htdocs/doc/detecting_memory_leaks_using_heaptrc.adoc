...
* If you use the https://castle-engine.io/build_tool[build tool], you can call it like `castle-engine --compiler-option=-glh compile` to compile.
* Alternatively, you can add them to https://castle-engine.io/project_manifest#compiler-options-and-paths[compiler options in CastleEngineManifest.xml].
