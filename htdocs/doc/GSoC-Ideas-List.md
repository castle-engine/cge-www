Ideas for students that wish to contribute to [Castle Game Engine](https://castle-engine.io/) within the [Google Summer of Code](https://summerofcode.withgoogle.com/):
