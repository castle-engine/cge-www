...
If for some reason https://github.com/castle-engine/castle-engine/releases[downloading releases from GitHub] doesn't work for you, we mirror them on https://sourceforge.net/projects/castle-engine/files/castle_game_engine/[SourceForge (files of castle-engine project)].
