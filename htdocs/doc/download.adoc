...
NOTE: Linux downloads require GLIBC >= 2.34. This should be OK on any modern Linux distribution. If you have https://www.debian.org/releases/oldstable/[Debian 11 (oldstable, bullseye)] you have to upgrade to at least https://www.debian.org/releases/stable/[Debian 12 (stable, bookworm)]. Or link:compiling_from_source.php[compile CGE from sources] to link to your current GLIBC. We plan to distribute the engine also as https://snapcraft.io/[snap package] in the future.
