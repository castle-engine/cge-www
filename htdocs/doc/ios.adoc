...
NOTE: From _Xcode_ GUI, the equivalent is to use _"Product -> Archive"_ menu item, then in the resulting window press _"Distribute"_ and select _"Release testing"_ option. This a prettier name for _"ad-hoc"_ distribution.
