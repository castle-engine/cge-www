...
+
Open the file with `.xcworkspace` extension in that directory. For now, all iOS projects use https://castle-engine.io/ios-Services#common-notes-for-services-using-cocoapods[CocoaPods] and so you need to open them through the `.xcworkspace` file, not just `.xcodeproj`.
...
+
image::https://castle-engine.io/images/thumb_size/xcode_select_team.png[Selecting a team in Xcode,link=https://castle-engine.io/images/original_size/xcode_select_team.png]
