...
The _iPhone Simulator_ is _not_ an emulator of a real iPhone device, i.e. it does not emulate the processor inside the iPhone. Rather, it's a modified version of the normal (desktop) macOS system, running on a normal (x86_64 or Aarch64) CPU.
