...
WARNING: This section describes new feature on https://github.com/castle-engine/castle-engine/tree/new-cameras[new-cameras branch], not yet merged with CGE master branch.
