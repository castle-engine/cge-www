...
cgeimg::block[
  web_2.png|Castle Game Engine - Simplest example in Firefox
]
...
2. link:web-demos/simplest_viewport[3D viewport, with animated light, dropping boxes with physics].
+
...
3. link:web-demos/simplest_invaders[2D "Invaders" game].
+
