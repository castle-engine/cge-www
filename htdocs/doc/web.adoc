...
- link:web-demos/examples/platformer[Platformer game] (https://github.com/castle-engine/castle-engine/tree/master/examples/2d_games/platformer[Source code])
...
- link:web-demos/examples/space_shooter[Space shooter] (https://github.com/castle-engine/castle-engine/tree/master/examples/2d_games/space_shooter[Source code])
...
- link:web-demos/examples/eye_of_beholder[Eye of Beholder] (https://github.com/castle-engine/castle-engine/tree/master/examples/3d_games/eye_of_beholder[Source code])
