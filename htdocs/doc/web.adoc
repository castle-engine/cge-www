...
- Save the user settings / save games (things stored in link:url#castle-config[castle-config:/], e.g. link:manual_user_prefs.php[UserConfig]) to webpage persistent storage.
