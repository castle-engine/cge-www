...
First, try the latest link:fpcupdeluxe[] which has a dedicated button _"WA"_ that installs most of the requirements listed below with a single click:

--
- FPC, with a cross-compiler for WebAssembly,
- Pas2js,
- compileserver.
--

If this works, you don't need to get these things manually.
