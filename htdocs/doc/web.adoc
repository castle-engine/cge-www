...
- You can read URL through which your page was accessed, and get query parameters of this URL. The use-case is to enable creating webpages that react to URL parameters, e.g. expose a model viewer on URL like `https://viewer.castle-engine.io/?url=http://example.org/model.gltf` . Use this:
+
--
