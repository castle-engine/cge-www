...
+
You can also link:#platform_default[set web platform as default], by creating `CastleProjectLocalSettings.json` or (TODO) using menu item _"Run -> Save Platform As Default in Project Local Settings"_.
