...
+
Source code in https://github.com/castle-engine/castle-engine/tree/webassm_platformer_test/examples/web/simplest_viewport[examples/web/simplest_viewport (on webassm_platformer_test branch)].
...
+
Source code in https://github.com/castle-engine/castle-engine/tree/webassm_platformer_test/examples/web/simplest[examples/web/simplest (on webassm_platformer_test branch)].
...
All the possibilities are described by the
//cgeref:TCastleProjectLocalSettings[].
`TCastleProjectLocalSettings` (TODO: this will link to API docs once we merge to master, for now https://github.com/castle-engine/castle-engine/blob/webassm_platformer_test/src/files/tools/castleinternalprojectlocalsettings.pas[see code]).

Note that you can also open the `CastleProjectLocalSettings.json` as a _design_ in the editor and edit the component in the object inspector. That's because
// TODO - link
//cgeref:TCastleProjectLocalSettings[]
