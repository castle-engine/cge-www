...
2. Enter any CGE project https://github.com/castle-engine/castle-engine/blob/master/examples/web/upload.sh#L72[that was tested for web] and compile and run it for web. Most other examples should already work with web too, actually, so feel free to experiment.
+
