...
All the possibilities are described by the https://github.com/castle-engine/castle-engine/blob/webassm_platformer_test/tools/build-tool/code/toolprojectlocalsettings.pas[TCastleProjectLocalSettings class].
