...
Inside the link:https://castle-engine.io/project_manifest[CastleEngineManifest.xml] you can declare which additional services you want to integrate with your iOS application. It looks like this:
...
* https://github.com/castle-engine/castle-engine/tree/master/tools/build-tool/data/ios/services/google_analytics/README.adoc[google_analytics]
