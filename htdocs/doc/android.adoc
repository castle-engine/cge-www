...
+
For your information (you will need this later), location of the Android SDK is visible in the Android Studio _Settings \-> Android SDK_. It looks like this, by default:
+
--
