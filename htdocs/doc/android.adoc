...
For your information (if some tool requires later to set e.g. `JAVA_HOME`), the Java installation can be located by going to _"File -> Settings"_ and there to _"Build, Execution, Deployment -> Build Tools -> Gradle -> Gradle JDK"_. See the screenshot below.
