...
----
# On Windows
# (note: it may fail in Cygwin terminal;
# better do this is regular Windows terminal invoked by super + "cmd").
...
And answer "Y" to all the questions. After carefully reading all the licenses listed, of course.
