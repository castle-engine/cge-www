...
+
If the above panel doesn't show Java location, look for `jbr` subdirectory in your Android Studio installation. E.g. on Windows it is usually located in `C:/Program Files/Android/Android Studio/jbr`.
...
1. We recommend that you just install the whole https://developer.android.com/studio[Android Studio]. Run it and it will automatically install the Android SDK for you.
+
