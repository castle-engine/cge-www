...
+
For your information (you will need this later), location of the Android SDK is visible in the Android Studio _File -> Settings -> Android SDK_. You need to have some project open to access this _Android Studio_ dialog -- just create a new empty project if you don't have any.
+
