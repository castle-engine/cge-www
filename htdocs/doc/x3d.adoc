...
+
In our engine, in addition to the standard X3D nodes, we also define a few _extension nodes_. E.g. we add nodes to make link:shaders[shader effects], link:x3d_extensions_screen_effects.php[screen (post-processing) effects], shadows and more.
